      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <p className="text-blue-700">
            En utilisant nos services, vous acceptez les présentes conditions générales dans leur intégralité.
            Si vous n'êtes pas d'accord avec une partie quelconque de ces conditions, veuillez ne pas utiliser nos services.
          </p>
        </motion.div>
      </section>
      <Footer />
