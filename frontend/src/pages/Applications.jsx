  ...
  return (
    <>
      ...
      <section>
        {/* Resume Section */}
        <div className="mb-10">
          <h1 className="text-lg font-medium mb-3">Votre CV</h1>
          {isEdit ? (
        ...
        {applicationsLoading ? (
          ...
          <p className="text-center text-gray-500">Aucune application trouvée.</p>
        ) : (
          <>
            <h1 className="text-lg font-medium mb-3">Emplois postulés</h1>
